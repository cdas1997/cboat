...
export default function WiredEarphones() {
    const data=ShopData.ShopProducts[3];
  ...
  <Card.Body>
    ...
    <Button variant="dark" className='Dbutn'><Link to={`/WiredEarphonesDetails/${top.sub_catagory_id}`} className='Dlink'>ADD TO CART</Link></Button>
    <Button variant="dark" className='Dbutn'><Link to={`/WiredEarphonesDetails/${top.sub_catagory_id}`} className='Dlink'>DETAILS</Link></Button>
  </Card.Body>
           </Card>
                    )
