...
export default function WirelessSpeakers() {
    const data=ShopData.ShopProducts[4];
  ...
  <Card.Body>
    ...
    <Button variant="dark" className='Dbutn'><Link to={`/WirelessSpeakersDetails/${top.sub_catagory_id}`} className='Dlink'>ADD TO CART</Link></Button>
    <Button variant="dark" className='Dbutn'><Link to={`/WirelessSpeakersDetails/${top.sub_catagory_id}`} className='Dlink'>DETAILS</Link></Button>
  </Card.Body>
           </Card>
                    )
