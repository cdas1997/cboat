...
export default function WirelessEarbuds() {
    const data=ShopData.ShopProducts[0];
  ...
  <Card.Body>
    ...
    <Button variant="dark" className='Dbutn'><Link to={`/WirelessEarbudsDetails/${top.sub_catagory_id}`} className='Dlink'>ADD TO CART</Link></Button>
    <Button variant="dark" className='Dbutn'><Link to={`/WirelessEarbudsDetails/${top.sub_catagory_id}`} className='Dlink'>DETAILS</Link></Button>
  </Card.Body>
           </Card>
                    )
